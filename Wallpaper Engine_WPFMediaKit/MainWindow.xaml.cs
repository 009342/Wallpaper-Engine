...
namespace Wallpaper_Engine_WPFMediaKit
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Main_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            mediaUriElement.Width = Main.Width;
            mediaUriElement.Height = Main.Height;
            ...
            t.Start();
            mediaUriElement.MediaEnded += Media_MediaEnded;
            mediaUriElement.MediaFailed += (sender2, e2) =>
        ...
        private IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            if (msg == WM_COPYDATA)
            {
                ...
                {
                    Show();
                    mediaUriElement.Source = new Uri(Encoding.UTF32.GetString(fm.str));
                    mediaUriElement.LoadedBehavior = WPFMediaKit.DirectShow.MediaPlayers.MediaState.Manual;
                    mediaUriElement.Play();
                }
                switch (fm.Fun)
                {
                    ...
                    case (int)EngineFunctionFlags.SetVolume:
                        mediaUriElement.Volume = double.Parse(Encoding.UTF32.GetString(fm.str));
                        break;
